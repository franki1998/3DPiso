...
export type Mode = 'edit' | 'walk' | 'overview' | 'plan'
...
export interface Furniture { id: string; name: string; room: string; type: string; objectName: string; width: number; depth: number; height: number; visible: boolean; position: Vec3; rotation: Vec3; catalogId?: string; color?: string }
...
export interface PlannerLayout { version: 2; name: string; updatedAt: string; furniture: Furniture[] }
